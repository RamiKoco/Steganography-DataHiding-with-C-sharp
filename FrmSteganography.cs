...
namespace Text2Image
{
    public partial class FrmSteganography : Form
    {
        ...
        private void Encrypt_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Þifreleme bilgileri eksik!\nLütfen önce bunlarý tamamlayýn.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            if (8*((height * (width/3)*3)/3 - 1) < fileSize + fileNameSize)
            {
                MessageBox.Show("Dosya boyutu çok büyük!\nBu dosyayý gizlemek için lütfen daha büyük bir resim seçin.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        {
            toolStripStatusLabel1.Text = "Þifreleniyor... Lütfen bekleyin";
            ...
            toolStripStatusLabel1.Text = "Þifreli resim baþarýyla kaydedildi.";
            EncriptionDone = true;
        ...
        {
            toolStripStatusLabel1.Text = "Þifre çözülüyor... Lütfen bekleyin";
            Application.DoEvents();
            int i, j = 0;
            bool[] t = new bool[8];
            bool[] rb = new bool[8];
            ...
            {
                MessageBox.Show("File \"" + resFName + "\"Zaten mevcut lütfen dosyayý kaydetmek için baþka bir yol seçin", "Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
                return;
            }
            else
                File.WriteAllBytes(DSaveFilePath + "\\" + resFName, res);
            toolStripStatusLabel1.Text = "Þifresi çözülen dosya baþarýyla kaydedildi.";
            Application.DoEvents();
        }
        ...
        private void byte2bool(byte inp, ref bool[] outp)
        {
            if(inp>=0 && inp<=255)
                ...
                throw new Exception("Girilen numara geçersiz.");
        }
        ...
        private void Decrypt_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Metin kutularý boþ olmamalýdýr!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                MessageBox.Show("Görüntü dosyasýný seçin.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
